...
static NSString *const kNXCircleViewRotationAnimationKey = @"kNXCircleViewRotationAnimationKey";

@implementation NXCircleView
...
- (void)defaultInit
{
    ...
    self.trackColor = [UIColor nx_colorWithHex:0xdedede];
    self.progressColor = [UIColor nx_colorWithHex:0xd21a1b];
    // 默认宽度
...
- (void)startRotating
{
    ...
    [self.layer addAnimation:rotationAnimation forKey:kNXCircleViewRotationAnimationKey];
}

- (void)stopRotating { [self.layer removeAnimationForKey:kNXCircleViewRotationAnimationKey]; }
@end
...
- (void)setTrack
{
    CGFloat radius = floor((CGRectGetWidth(self.bounds) - _progressWidth) /
2.0);
